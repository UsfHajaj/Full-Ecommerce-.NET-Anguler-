...
namespace Ecom.infrastructure.Data.Migrations
{
    ...
    [Migration("20250616060519_update-for-sql-changes")]
    partial class updateforsqlchanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecom.Core.Entites.Products.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecom.Core.Entites.Products.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecom.Core.Entites.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecom.Core.Entites.Products.Photo", b =>
                {
                    b.HasOne("Ecom.Core.Entites.Products.Product", null)
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("Ecom.Core.Entites.Products.Product", b =>
                {
                    b.HasOne("Ecom.Core.Entites.Products.Category", "Category")
                        .WithMany()
